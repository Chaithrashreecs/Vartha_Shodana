...
def main():
    ...
    if page == "Home":
        ...
        if st.button('Predict'):
            # Preprocess text
            if 'adhaar' in input_sms or 'atm pin' in input_sms or 'bank' in input_sms or 'congratulations' in input_sms or 'otp' in input_sms or 'congrats' in input_sms:
                result=1
            else:
                try:
        ...
        developers = [
            {
                ...
                "image": r"C:\Users\Chaithrashree C S\Downloads\disha.jpeg"
            },
            {
                "name": "Chaithrashree CS",
                "role": "Developer",
                "bio": "3rd year Student at Srinivas Institute of Technology",
                "image": r"C:\Users\Chaithrashree C S\Downloads\chaithra.jpeg"
            }
        ]
        ...
        guide = {
            ...
            "image": r"C:\Users\Chaithrashree C S\Downloads\mam.jpeg"  
        }
